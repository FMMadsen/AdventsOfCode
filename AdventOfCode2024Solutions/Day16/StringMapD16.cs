...
namespace AdventOfCode2024Solutions.Day16
{
    public class StringMapD16
    {
        ...
        /// </summary>
        public StringMapD16(string[] aMap, Dictionary<MapCharD16, Func<GameObject>> aCharToTypeList, Dictionary<char, MapCharD16> aCharToEnumList)
        {
            MapValue = aMap;
