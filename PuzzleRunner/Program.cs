...
namespace PuzzleRunner
{
    internal class Program
    {
        ...
        private static void RunAdventOfCode2025()
        {
            var repo = new DataSetRepo(AdventOfCode2025Solutions.Constants.DataSetsSourceFolderName);
            Console.WriteLine($"Advent of Code year 2025");
            Console.WriteLine("-------------------------------------------");
            RunPuzzle(new AdventOfCode2025Solutions.Day01.Solution(), repo, AdventOfCode2025Solutions.Constants.DataSetFileDay01);
            RunPuzzle(new AdventOfCode2025Solutions.Day02.Solution(), repo, AdventOfCode2025Solutions.Constants.DataSetFileDay02);
