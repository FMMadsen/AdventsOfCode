namespace AdventOfCode2023Solutions.Day16
{
    internal class Contraption
    {
        ...
        private static char[,] CreateMap(string[] datasetLines)
        {
        ...
        private static string[,] CreateEnergyMap(int noOfRows, int noOfCols)
        {
        ...
        private void ResetEnergyMap()
        {
            for (int columnIndex = 0; columnIndex < noOfCols; columnIndex++)
                for (int rowIndex = 0; rowIndex < noOfRows; rowIndex++)
                    energyMap[rowIndex, columnIndex] = "";
        }
    }
}
