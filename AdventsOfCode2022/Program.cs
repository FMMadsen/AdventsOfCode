...
using AdventsOfCode2022.Y2023Day1;
using AdventsOfCode2022.Y2023Day2;
using AdventsOfCode2022.Y2023Day3;
...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        ExecutePuzzle(2022, 1, false, false, "Elves inventory list", @"Datasets\Day01ElvesInventoryList.txt");
        ExecutePuzzle(2022, 2, false, false, "Rock-Paper-Scissors", @"Datasets\Day02RPSGameLog.txt");
        ExecutePuzzle(2022, 3, false, false, "Misplaced supplies", @"Datasets\Day03RucksacksContent.txt");
        ExecutePuzzle(2022, 4, false, false, "Camp cleanup", @"Datasets\Day04SectionAssignments.txt");
        ExecutePuzzle(2022, 5, false, false, "Crane & supply stacks", @"Datasets\Day05CraneAndSupplyStacks.txt");
        ExecutePuzzle(2022, 6, false, false, "Tuning trouble", @"Datasets\Day06TuningTrouble.txt");
        ExecutePuzzle(2022, 7, false, false, "Tuning trouble", @"Datasets\Day07FileDirectorySizes.txt");
        ...
        ExecutePuzzle(2023, 1, false, false, "2023 - Day 1: Trebuchet?!", @"Datasets\Y2023D1_test2.txt");
        ExecutePuzzle(2023, 2, false, false, "2023 - Day 2 : ", @"Datasets\Y2023D2_test.txt");
        ExecutePuzzle(2023, 3, false, false, "2023 - Day 3 : ", @"Datasets\Y2023D3_test.txt");
    ...
    private static void ExecutePuzzle(int year, int day, bool extraPrintoutPart1, bool extraPrintoutPart2, string puzzleName, string datasetFile)
    {
        ConsoleOutLine();
        ...
        if (year == 2023)
        {
            ...
            {
                case 1:
                    part1Answer = Y2023D1Puzzle.SolvePart1(datasetLines, extraPrintoutPart1);
                    part2Answer = Y2023D1Puzzle.SolvePart2(datasetLines, extraPrintoutPart2);
                    break;
                case 2:
                    part1Answer = Y2023D2Puzzle.SolvePart1(datasetLines, extraPrintoutPart1);
                    part2Answer = Y2023D2Puzzle.SolvePart2(datasetLines, extraPrintoutPart2);
                    break;
                case 3:
                    part1Answer = Y2023D3Puzzle.SolvePart1(datasetLines, extraPrintoutPart1);
                    part2Answer = Y2023D3Puzzle.SolvePart2(datasetLines, extraPrintoutPart2);
                    break;
            }
        }
